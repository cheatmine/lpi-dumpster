...
Torso.Parent = char; Torso.Name = "Torso"; Torso.BrickColor = BrickColor.new("Bright blue")
Head.Parent = char; Head.Name = "Head"; Head.BrickColor = BrickColor.new("Bright yellow")
RightArm.Parent = char; RightArm.Name = "Right Arm"; RightArm.BrickColor = BrickColor.new("Bright yellow")
RightLeg.Parent = char; RightLeg.Name = "Right Leg"; RightLeg.BrickColor = BrickColor.new("Bright green")
LeftArm.Parent = char; LeftArm.Name = "Left Arm"; LeftArm.BrickColor = BrickColor.new("Bright yellow")
LeftLeg.Parent = char; LeftLeg.Name = "Left Leg"; LeftLeg.BrickColor = BrickColor.new("Bright green")
...
connection = game:GetService("RunService").Heartbeat:Connect(sync)
